...
var G__42147 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__42147,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__42147;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq42149){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42150,G__42151,seq42149__$2);
});
...
var map__42156 = m;
var map__42156__$1 = (((((!((map__42156 == null))))?(((((map__42156.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42156.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42156):map__42156);
var file = cljs.core.get.call(null,map__42156__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42156__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42156__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__42156,map__42156__$1,file,line,column){
return (function (p1__42155_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__42155_SHARP_));
});})(map__42156,map__42156__$1,file,line,column))
...
var temp__5720__auto___42158 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___42158)){
var message_42159 = temp__5720__auto___42158;
cljs.core.println.call(null,message_42159);
} else {
}
...
var temp__5720__auto___42160 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___42160)){
var message_42161 = temp__5720__auto___42160;
cljs.core.println.call(null,message_42161);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__42162 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__42162,"/"].join('');
} else {
return G__42162;
}
})();
...
var G__42164 = exception.stack;
var G__42164__$1 = (((G__42164 == null))?null:clojure.string.split_lines.call(null,G__42164));
var G__42164__$2 = (((G__42164__$1 == null))?null:cljs.core.get.call(null,G__42164__$1,depth));
if((G__42164__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42164__$2);
}
} else {
...
var vec__42165 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__42165,(0),null);
var column = cljs.core.nth.call(null,vec__42165,(1),null);
var vec__42168 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__42168,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__42168,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__42168,(2),null);
...
var m__$1 = (function (){var G__42171 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__42175 = (function (){var G__42174 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__42174);
} else {
return G__42174;
}
})();
...
return cljs.core.vary_meta.call(null,G__42176,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__42180 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__42180,(0),null);
var types = vec__42180;
...
return cljs.core.map.call(null,(function (p__42183){
var vec__42184 = p__42183;
var ns = cljs.core.nth.call(null,vec__42184,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__42184,(1),null);
return ((function (vec__42184,ns,vars__$1){
return (function (){
...
var G__42187 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__42187__$1 = (((G__42187 instanceof cljs.core.Keyword))?G__42187.fqn:null);
switch (G__42187__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1){
return (function (){
var seq__42188 = cljs.core.seq.call(null,vars__$1);
var chunk__42189 = null;
var count__42190 = (0);
var i__42191 = (0);
while(true){
if((i__42191 < count__42190)){
var v = cljs.core._nth.call(null,chunk__42189,i__42191);
var temp__5720__auto___42193 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___42193)){
var t_42194 = temp__5720__auto___42193;
each_fixture_fn.call(null,((function (seq__42188,chunk__42189,count__42190,i__42191,t_42194,temp__5720__auto___42193,v,each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42194)));
});})(seq__42188,chunk__42189,count__42190,i__42191,t_42194,temp__5720__auto___42193,v,each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1))
);
} else {
}


var G__42195 = seq__42188;
var G__42196 = chunk__42189;
var G__42197 = count__42190;
var G__42198 = (i__42191 + (1));
seq__42188 = G__42195;
chunk__42189 = G__42196;
count__42190 = G__42197;
i__42191 = G__42198;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__42188);
if(temp__5720__auto__){
var seq__42188__$1 = temp__5720__auto__;
...
var G__42199 = cljs.core.chunk_rest.call(null,seq__42188__$1);
var G__42200 = c__4550__auto__;
var G__42201 = cljs.core.count.call(null,c__4550__auto__);
var G__42202 = (0);
seq__42188 = G__42199;
chunk__42189 = G__42200;
count__42190 = G__42201;
i__42191 = G__42202;
continue;
} else {
var v = cljs.core.first.call(null,seq__42188__$1);
var temp__5720__auto___42203__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___42203__$1)){
var t_42204 = temp__5720__auto___42203__$1;
each_fixture_fn.call(null,((function (seq__42188,chunk__42189,count__42190,i__42191,t_42204,temp__5720__auto___42203__$1,v,seq__42188__$1,temp__5720__auto__,each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_42204)));
});})(seq__42188,chunk__42189,count__42190,i__42191,t_42204,temp__5720__auto___42203__$1,v,seq__42188__$1,temp__5720__auto__,each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1))
);
} else {
}


var G__42205 = cljs.core.next.call(null,seq__42188__$1);
var G__42206 = null;
var G__42207 = (0);
var G__42208 = (0);
seq__42188 = G__42205;
chunk__42189 = G__42206;
count__42190 = G__42207;
i__42191 = G__42208;
continue;
}
} else {
...
});})(each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1))
);
});})(each_fixture_fn,G__42187,G__42187__$1,env,once_fixtures,each_fixtures,vec__42184,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42187__$1)].join('')));

}
})());
});
;})(vec__42184,ns,vars__$1))
