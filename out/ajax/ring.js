...
ajax.ring.ring_response_format.cljs$core$IFn$_invoke$arity$1 = (function (p__43062){
var map__43063 = p__43062;
var map__43063__$1 = (((((!((map__43063 == null))))?(((((map__43063.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43063.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43063):map__43063);
var map__43064 = cljs.core.get.call(null,map__43063__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var map__43064__$1 = (((((!((map__43064 == null))))?(((((map__43064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43064):map__43064);
var read = cljs.core.get.call(null,map__43064__$1,new cljs.core.Keyword(null,"read","read",1140058661));
var description = cljs.core.get.call(null,map__43064__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var content_type = cljs.core.get.call(null,map__43064__$1,new cljs.core.Keyword(null,"content-type","content-type",-508222634));
