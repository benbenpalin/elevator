...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__43073){
var map__43074 = p__43073;
var map__43074__$1 = (((((!((map__43074 == null))))?(((((map__43074.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43074.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43074):map__43074);
var handler = cljs.core.get.call(null,map__43074__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4131__auto__ = p1__43076_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__43077){
...
var request = map__43078__$1;
var interceptors = cljs.core.get.call(null,map__43078__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
