...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__42835){
var map__42836 = p__42835;
var map__42836__$1 = (((((!((map__42836 == null))))?(((((map__42836.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42836.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42836):map__42836);
var request = map__42836__$1;
var response_format = cljs.core.get.call(null,map__42836__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__42841){
