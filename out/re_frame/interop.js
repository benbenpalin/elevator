...
return [(function (){var pred__40201 = cljs.core.instance_QMARK_;
var expr__40202 = reactive_val;
if(cljs.core.truth_(pred__40201.call(null,reagent.ratom.RAtom,expr__40202))){
return "ra";
} else {
if(cljs.core.truth_(pred__40201.call(null,reagent.ratom.RCursor,expr__40202))){
return "rc";
} else {
if(cljs.core.truth_(pred__40201.call(null,reagent.ratom.Reaction,expr__40202))){
return "rx";
} else {
if(cljs.core.truth_(pred__40201.call(null,reagent.ratom.Track,expr__40202))){
return "tr";
} else {
return "other";
}
