...
var G__40034 = o;
(G__40034[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__40035__delegate = function (args){
...
while (G__40036__i < G__40036__a.length) {G__40036__a[G__40036__i] = arguments[G__40036__i + 0]; ++G__40036__i;}
  args = new cljs.core.IndexedSeq(G__40036__a,0,null);
} 
return G__40035__delegate.call(this,args);};
G__40035.cljs$lang$maxFixedArity = 0;
G__40035.cljs$lang$applyTo = (function (arglist__40037){
var args = cljs.core.seq(arglist__40037);
return G__40035__delegate(args);
});
...
var G__40038 = o;
(G__40038[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__40039__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__40040__i < G__40040__a.length) {G__40040__a[G__40040__i] = arguments[G__40040__i + 0]; ++G__40040__i;}
  args = new cljs.core.IndexedSeq(G__40040__a,0,null);
} 
return G__40039__delegate.call(this,args);};
...
return G__40039__delegate(args);
});
...
var G__40043 = props;
var G__40043__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__40043,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40043);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__40043__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__40044){
...
var props = map__40045__$1;
var class$ = cljs.core.get.call(null,map__40045__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__40045,map__40045__$1,props,class$){
return (function (c){
...
});})(map__40045,map__40045__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__40047){
...
var on_write = cljs.core.get.call(null,map__40048__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__40048,map__40048__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__40048,map__40048__$1,on_write))
);
} else {
...
var G__40051 = jsprops;
(G__40051["defaultValue"] = value);

(G__40051["onChange"] = ((function (G__40051,v,value,on_change){
return (function (p1__40050_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__40050_SHARP_);
});})(G__40051,v,value,on_change))
);
...
var vec__40054 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__40054,(0),null);
var id = cljs.core.nth.call(null,vec__40054,(1),null);
var class$ = cljs.core.nth.call(null,vec__40054,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___40058 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___40058 == null)){
} else {
var key_40059 = temp__5724__auto___40058;
(jsprops["key"] = key_40059);
}
...
var temp__5724__auto___40060 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___40060 == null)){
} else {
var key_40061 = temp__5724__auto___40060;
reagent.impl.template.oset.call(null,jsprops,"key",key_40061);
}
...
var G__40062 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__40062["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40066){
...
break;
default:
var G__40073 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__40073;
continue;
...
var n__4607__auto___40075 = a.length;
var i_40076 = (0);
while(true){
if((i_40076 < n__4607__auto___40075)){
(a[i_40076] = reagent.impl.template.as_element.call(null,(a[i_40076])));

var G__40077 = (i_40076 + (1));
i_40076 = G__40077;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___40078 = a.length;
var i_40079 = (0);
while(true){
if((i_40079 < n__4607__auto___40078)){
var val_40080 = (a[i_40079]);
if(((cljs.core.vector_QMARK_.call(null,val_40080)) && ((reagent.impl.template.key_from_vec.call(null,val_40080) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_40079] = reagent.impl.template.as_element.call(null,val_40080));

var G__40081 = (i_40079 + (1));
i_40079 = G__40081;
continue;
} else {
}
...
var ctx = ({});
var vec__40082 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__40082,(0),null);
var derefed = cljs.core.nth.call(null,vec__40082,(1),null);
...
var G__40085 = (cljs.core.count.call(null,argv) - first_child);
switch (G__40085) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__40085){
