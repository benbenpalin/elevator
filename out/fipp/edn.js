...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__42304,open,xs,sep,close,f){
...
var printer = map__42305__$1;
var print_level = cljs.core.get.call(null,map__42305__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__42305__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__42307 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__42307,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__42307;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,((function (printer__$1,map__42305,map__42305__$1,printer,print_level,print_length){
return (function (p1__42303_SHARP_){
return f.call(null,printer__$1,p1__42303_SHARP_);
});})(printer__$1,map__42305,map__42305__$1,printer,print_level,print_length))
...
fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k42309,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k42309,else__4388__auto__);
...
return (function (ret__4407__auto__,p__42314){
var vec__42315 = p__42314;
var k__4408__auto__ = cljs.core.nth.call(null,vec__42315,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__42315,(1),null);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__42308){
var self__ = this;
var G__42308__$1 = this;
return (new cljs.core.RecordIter((0),G__42308__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__42318){
var self__ = this;
...
var tag = cljs.core.get.call(null,map__42319__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__42319__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
return (function (printer,p__42321){
var vec__42322 = p__42321;
var k = cljs.core.nth.call(null,vec__42322,(0),null);
var v = cljs.core.nth.call(null,vec__42322,(1),null);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this42310,other42311){
var self__ = this;
var this42310__$1 = this;
return (((!((other42311 == null)))) && ((this42310__$1.constructor === other42311.constructor)) && (cljs.core._EQ_.call(null,this42310__$1.symbols,other42311.symbols)) && (cljs.core._EQ_.call(null,this42310__$1.print_meta,other42311.print_meta)) && (cljs.core._EQ_.call(null,this42310__$1.print_length,other42311.print_length)) && (cljs.core._EQ_.call(null,this42310__$1.print_level,other42311.print_level)) && (cljs.core._EQ_.call(null,this42310__$1.__extmap,other42311.__extmap)));
});
...
fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__42308){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__42325 = cljs.core.keyword_identical_QMARK_;
var expr__42326 = k__4393__auto__;
if(cljs.core.truth_(pred__42325.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__42326))){
return (new fipp.edn.EdnPrinter(G__42308,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__42325.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__42326))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__42308,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__42325.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__42326))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__42308,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__42325.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__42326))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__42308,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__42308),null));
}
}
}
}
...
fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__42308){
var self__ = this;
var this__4384__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__42308,self__.__extmap,self__.__hash));
});
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__42312){
var extmap__4424__auto__ = (function (){var G__42328 = cljs.core.dissoc.call(null,G__42312,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__42312)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__42328);
} else {
return G__42328;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__42312),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__42312),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__42312),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__42312),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__42332 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__42333 = false;
cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__42333;

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__42332;
}});
