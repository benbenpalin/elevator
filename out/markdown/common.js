...
var len__4730__auto___43164 = arguments.length;
var i__4731__auto___43165 = (0);
while(true){
if((i__4731__auto___43165 < len__4730__auto___43164)){
args__4736__auto__.push((arguments[i__4731__auto___43165]));

var G__43166 = (i__4731__auto___43165 + (1));
i__4731__auto___43165 = G__43166;
continue;
} else {
}
break;
...
/** @this {Function} */
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq43163){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43163));
});
...
while(true){
var temp__5718__auto__ = cljs.core.re_seq.call(null,cljs.core.re_pattern.call(null,[markdown.common.escape_delimiter,"\\d+",markdown.common.escape_delimiter].join('')),text);
if(cljs.core.truth_(temp__5718__auto__)){
var matches = temp__5718__auto__;
var G__43169 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5718__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__43167_SHARP_,p1__43167_SHARP_);
});})(text,state,matches,temp__5718__auto__))
);
});})(text,state,matches,temp__5718__auto__))
,text,matches);
var G__43170 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5718__auto__){
return (function (p1__43168_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__43168_SHARP_,matches);
});})(text,state,matches,temp__5718__auto__))
);
text = G__43169;
state = G__43170;
...
var vec__43179 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__43182 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__43182,(0),null);
var new_state = cljs.core.nth.call(null,vec__43182,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__43179,(0),null);
var new_state = cljs.core.nth.call(null,vec__43179,(1),null);
var G__43186 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__43187 = cljs.core.PersistentVector.EMPTY;
var G__43188 = cljs.core.rest.call(null,tokens);
var G__43189 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__43186;
buf = G__43187;
tokens = G__43188;
cur_state = G__43189;
...
var G__43190 = out;
var G__43191 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__43192 = cljs.core.rest.call(null,tokens);
var G__43193 = cur_state;
out = G__43190;
buf = G__43191;
tokens = G__43192;
cur_state = G__43193;
...
var G__43194 = out;
var G__43195 = buf;
var G__43196 = cljs.core.rest.call(null,tokens);
var G__43197 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__43194;
buf = G__43195;
tokens = G__43196;
cur_state = G__43197;
...
var G__43198 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__43199 = buf;
var G__43200 = cljs.core.rest.call(null,tokens);
var G__43201 = cur_state;
out = G__43198;
buf = G__43199;
tokens = G__43200;
cur_state = G__43201;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__43202_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__43202_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__43203_SHARP_){
return ((cljs.core._EQ_.call(null,"#",p1__43203_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__43203_SHARP_)));
...
return ["<h",cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading),(cljs.core.truth_(heading_anchors)?[" id=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.replace.call(null,clojure.string.lower_case.call(null,text__$1)," ","&#95;")),"\""].join(''):null),">",cljs.core.str.cljs$core$IFn$_invoke$arity$1(text__$1),"</h",cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading),">"].join('');
} else {
return null;
}
});
