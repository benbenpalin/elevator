...
return cljs.core.map.call(null,(function (p1__43341_SHARP_){
return cljs.core.identity.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),p1__43341_SHARP_], null));
}),cljs.core.map.call(null,clojure.string.trim,(function (p1__43340_SHARP_){
return clojure.string.split.call(null,p1__43340_SHARP_,/\|/);
}).call(null,clojure.string.trim.call(null,(function (p1__43339_SHARP_){
if(cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__43339_SHARP_),"|")){
return cljs.core.apply.call(null,cljs.core.str,cljs.core.rest.call(null,p1__43339_SHARP_));
} else {
return p1__43339_SHARP_;
}
}).call(null,text)))));
});
